...
**Estado:** aula integral revisada técnica e pedagogicamente em `aulas/aula-01-o-que-e-pensamento-computacional.md`, com prática associada revisada em `praticas/pratica-01-reconhecendo-pensamento-computacional.md`.
...
**Estado:** aula integral revisada técnica e pedagogicamente em `aulas/aula-04-abstracao-e-modelos.md`, com prática associada revisada em `praticas/pratica-04-modelando-o-mesmo-problema.md`.
...
**Estado:** [aula integral revisada técnica e pedagogicamente](aulas/aula-07-o-que-e-um-algoritmo.md), com [prática associada revisada](praticas/pratica-07-avaliando-e-formulando-algoritmos.md).
